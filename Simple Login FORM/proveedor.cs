    ...
    public partial class proveedor : Form
    {
        ...
        public void CrearProveedor(string nombre, string mail, string telefono, string domicilio, string pagina)
        {
            using (MySqlConnection con = new MySqlConnection(DBConfig.GetConnectionString()))
            {
                ...
                string sqlProveedor = "INSERT INTO proveedores (pagina, ID_persona) VALUES (@pagina, @idPersona)";
                MySqlCommand cmd2 = new MySqlCommand(sqlProveedor, con);
                cmd2.Parameters.AddWithValue("@pagina", pagina);
        ...
        public DataTable FiltrarProveedor(string nombre)
        {
            adding = false;
            DataTable dt = new DataTable();
            try
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            DataTable resultados = FiltrarProveedor(nombre_completo);
